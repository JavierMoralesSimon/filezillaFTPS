...
![Generación de un certificado TLS](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/1.png)
...
![Configuración de un listener](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/2.1.png)
2. Vamos a FTP and FTP over TLS (FTPS) - Passive mode y definimos un rango de puertos como por ejemplo 50000-50100.
![Rango de puertos](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/2.2.png)
...
![Apertura de puertos](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/2.3.png)
...
![Conexión segura para usuarios](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/3.png)
...
![Creación de conexión](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/4.1.png)
4. En "Opciones de transferencia" poner pasivo.
![Modo pasivo](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/4.2.png)
5. Nos conectamos.
![Conexión](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/4.3.png)
6. Si damos al candado de abajo, nos salen los detalles del certificado.
![Detalles del certificado](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/4.4.png)

## Prueba de fuego
1. Desconectarse.
![Desconexión](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/5.1.png)
2. Cambiar la configuración del sitio en el cliente a "Usar solo FTP plano (inseguro)".
![Cambio en la configuración](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/5.2.png)
3. Intento de conexión que da error.
![Conexión errónea](https://github.com/JavierMoralesSimon/filezillaFTPS/blob/main/Capturas/5.3.png)
